...
IconSelect.DEFAULT.ICONS_WIDTH = 60;
IconSelect.DEFAULT.ICONS_HEIGHT = 30;
IconSelect.DEFAULT.BOX_ICON_SPACE = 1;
IconSelect.DEFAULT.HORIZONTAL_ICON_NUMBER = 4;
IconSelect.DEFAULT.VECTORAL_ICON_NUMBER = 6;

IconSelect.COMPONENT_ICON_FILE_PATH = "assets/control/icon-select/arrow.png";
...
function IconSelect($$elementID, $$parameters) {
    ...
    _View.createUI = function($parameters){
        ...
        _View.selectedIconImgElement.setAttribute('id', "taskIcon");
    ...
    _View.createIcon = function($iconFilePath, $iconValue, $index, $parameters){
        ...
        // iconImgElement.setAttribute('class', 'svg-black');
